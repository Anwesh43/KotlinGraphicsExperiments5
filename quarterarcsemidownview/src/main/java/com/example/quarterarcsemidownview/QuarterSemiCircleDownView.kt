package com.example.quarterarcsemidownview
...
fun Canvas.drawQuarterArcSemiDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawQASDNode(i : Int, scale : Float, paint : Paint) {
...
class QuarterSemiCircleDownView(ctx : Context) : View(ctx) {
    ...
    data class QuarterSemiCircleDown(var i : Int = 0, val state : State = State()) {

        private var curr : QASDNode = QASDNode(0)
