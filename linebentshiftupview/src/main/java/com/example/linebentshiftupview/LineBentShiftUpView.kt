package com.example.linebentshiftupview
...
fun Canvas.drawLineBentShiftUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBSUNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBentShiftUp(scale, w, h, paint)
}

class LineBentShiftUpView(ctx : Context) : View(ctx) {
    ...
    data class LineBentShiftUp(var i : Int) {
