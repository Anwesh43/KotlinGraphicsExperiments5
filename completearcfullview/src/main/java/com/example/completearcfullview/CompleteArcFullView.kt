...
class CompleteArcFullView(ctx : Context) : View(ctx) {
    ...
    data class CompleteArcFull(var i : Int) {

        private var curr : CAFNode = CAFNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : CompleteArcFullView {
            val view : CompleteArcFullView = CompleteArcFullView(activity)
