...
class EitherLineRotIntoView(ctx : Context) : View(ctx) {
    ...
    data class ELRINode(var i : Int = 0, val state : State = State()) {

        private var next : ELRINode? = null
        private var prev : ELRINode? = null
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawELRINode(i, state.scale, paint)
        }
        ...
        fun getNext(dir : Int, cb : () -> Unit) : ELRINode {
            var curr : ELRINode? = prev
            if (dir === 1) {
                curr = next
            }
            if (curr != null) {
    ...
    data class EitherLineRotInto(var i : Int) {

        private var curr : ELRINode = ELRINode(0)
    ...
    companion object {
        ...
        fun create(activity: Activity) : EitherLineRotIntoView {
            val view : EitherLineRotIntoView = EitherLineRotIntoView(activity)
