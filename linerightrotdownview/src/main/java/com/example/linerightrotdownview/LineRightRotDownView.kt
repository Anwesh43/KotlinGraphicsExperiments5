package com.example.linerightrotdownview
...
fun Canvas.drawLineRightRotDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineRightRotDownView(ctx : Context) : View(ctx) {
    ...
    data class LineRightRotDown(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineRightRotDownView {
            val view : LineRightRotDownView = LineRightRotDownView(activity)
