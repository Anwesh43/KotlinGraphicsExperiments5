package com.example.perplineanglerightview
...
fun Canvas.drawPerpLineAngleRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawPLARNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawPerpLineAngleRight(scale, w, h, paint)
}

class PerpLineAngleRightView(ctx : Context) : View(ctx) {
