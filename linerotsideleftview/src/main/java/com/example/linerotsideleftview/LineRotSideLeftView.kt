package com.example.linerotsideleftview
...
fun Canvas.drawLineRotSideLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLRSLNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineRotSideLeft(scale, w, h, paint)
}

class LineRotSideLeftView(ctx : Context) : View(ctx) {
    ...
    data class LineRotSideLeft(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity: Activity) : LineRotSideLeftView {
            val view : LineRotSideLeftView = LineRotSideLeftView(activity)
