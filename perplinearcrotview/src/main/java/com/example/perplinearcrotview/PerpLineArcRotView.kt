package com.example.perplinearcrotview
...
fun Canvas.drawPerpLineArcRot(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawPLARNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawPerpLineArcRot(scale, w, h, paint)
}

class PerpLineArcRotView(ctx : Context) : View(ctx) {
    ...
    data class PerpLineArcRot(var i : Int) {
    ...
    data class Renderer(var view : PerpLineArcRotView) {

        private val animator : Animator = Animator(view)
        private val plar : PerpLineArcRot = PerpLineArcRot(0)
