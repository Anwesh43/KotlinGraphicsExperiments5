package com.example.arcmainconcleftview
...
fun Canvas.drawArcMainConcLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawAMCLNode(i : Int, scale : Float, paint : Paint) {
...
class ArcMainConcLeftView(ctx : Context) : View(ctx) {
    ...
    data class ArcMainConcLeft(var i : Int) {

        private var curr : AMCLNode = AMCLNode(0)
