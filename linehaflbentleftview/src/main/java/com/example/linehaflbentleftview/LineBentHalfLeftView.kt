package com.example.linehaflbentleftview
...
fun Canvas.drawLineBentHalfLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineBentHalfLeftView(ctx : Context) : View(ctx) {
    ...
    data class LineBentHalfLeft(var i : Int = 0) {
    ...
    data class Renderer(var view : LineBentHalfLeftView) {

        private val animator : Animator = Animator(view)
        private val paint : Paint = Paint(Paint.ANTI_ALIAS_FLAG)
        private val lbhl : LineBentHalfLeft = LineBentHalfLeft(0)
