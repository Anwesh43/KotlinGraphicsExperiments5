package com.example.perplinejoinarcview
...
fun Canvas.drawPerpLineJoinArc(scale : Float, w : Float, h : Float, paint : Paint) {
...
class PerpLineJoinArcView(ctx : Context) : View(ctx) {
    ...
    data class PerpLineJoinArc(var i : Int = 0, val state : State = State()) {

        private var curr : PLJANode = PLJANode(0)
